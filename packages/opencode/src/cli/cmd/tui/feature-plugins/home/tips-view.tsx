...
const TIPS = [
  ...
  "Anvil auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Anvil auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Anvil uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Anvil from reading sensitive files",
  "Use {highlight}anvil run{/highlight} for non-interactive scripting",
  "Use {highlight}anvil --continue{/highlight} to resume the last session",
  "Use {highlight}anvil run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}anvil serve{/highlight} for headless API access to Anvil",
  "Use {highlight}anvil run --attach{/highlight} to connect to a running server",
  "Run {highlight}anvil upgrade{/highlight} to update to the latest version",
  "Run {highlight}anvil auth list{/highlight} to see all configured providers",
  "Run {highlight}anvil agent create{/highlight} for guided agent creation",
  "Use {highlight}/anvil{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}anvil github install{/highlight} to set up the GitHub workflow",
